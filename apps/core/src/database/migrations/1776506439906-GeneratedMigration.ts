...
export class GeneratedMigration1776506439906 implements MigrationInterface {
  name = 'GeneratedMigration1776506439906';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "auth"."account" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "main"."asset" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "main"."asset" ADD "owner_profile_id" uuid`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notification"."notification" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "main"."profile" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "auth"."user" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "main"."message_asset" ADD CONSTRAINT "PK_1704939b5304472a1476edc484f" PRIMARY KEY ("message_id")`,
    );
    await queryRunner.query(`DROP INDEX "main"."IDX_69fd2e009a557aa529ace0a0ee"`);
    await queryRunner.query(`ALTER TABLE "main"."message_asset" DROP COLUMN "asset_id"`);
    await queryRunner.query(`ALTER TABLE "main"."message_asset" ADD "asset_id" uuid NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "main"."message_asset" DROP CONSTRAINT "PK_1704939b5304472a1476edc484f"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "main"."profile_follow" ADD CONSTRAINT "PK_5c2a1d5811b9b9611a90ce78fb5" PRIMARY KEY ("following_profile_id")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "main"."profile_follow" DROP CONSTRAINT "PK_5c2a1d5811b9b9611a90ce78fb5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "main"."profile_follow" ADD CONSTRAINT "PK_3701cc1c94104fd2968bc50c6a9" PRIMARY KEY ("following_profile_id", "follower_profile_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "main"."profile_follow" DROP CONSTRAINT "PK_3701cc1c94104fd2968bc50c6a9"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "main"."profile_to_profile_configuration" ADD CONSTRAINT "PK_6ac086446b4d4f9fb73c3a2561d" PRIMARY KEY ("target_profile_id")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "main"."profile_to_profile_configuration" DROP CONSTRAINT "PK_6ac086446b4d4f9fb73c3a2561d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "main"."profile_to_profile_configuration" ADD CONSTRAINT "PK_ad741672888ca43b310895d09f2" PRIMARY KEY ("target_profile_id", "source_profile_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "main"."profile_to_profile_configuration" DROP CONSTRAINT "PK_ad741672888ca43b310895d09f2"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "main"."message_asset" DROP COLUMN "asset_id"`);
    await queryRunner.query(`ALTER TABLE "main"."message_asset" ADD "asset_id" integer NOT NULL`);
    await queryRunner.query(
      `CREATE INDEX "IDX_69fd2e009a557aa529ace0a0ee" ON "main"."message_asset" ("asset_id") `,
    );
    await queryRunner.query(
